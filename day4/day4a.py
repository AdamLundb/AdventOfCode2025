...
#print(check_if_coordinate_is_on_bounding_box(0, 2, data))
#print(check_if_coordinate_is_on_bounding_box(1, 0, data))
#print(check_if_coordinate_is_on_bounding_box(len(data[0]), 2, data), data[0], len(data[0]))
#print(check_if_coordinate_is_on_bounding_box(1, len(data), data), len(data))
#print(data[0][1])
